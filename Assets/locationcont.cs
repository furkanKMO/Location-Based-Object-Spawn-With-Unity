...
//public class locationcont : MonoBehaviour {
...
//        latitude =  40.9143062f;
//        longitude = 38.3228113f;
...
//          randomPokemonGO = Instantiate(Pokemons[randomPokemon], new Vector3( latitude, randomX, longitude), Quaternion.identity) as GameObject;
...
public class locationcont : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        var andyObject = Instantiate(prefab, new Vector3(xx, yy, zz), Quaternion.identity) as GameObject;
